...
이슈/PRD는 `.scratch/<feature>/` 아래 마크다운 파일로 관리. See `docs/agents/issue-tracker.md`.

### Triage labels

기본 라벨 어휘 사용(`needs-triage` / `needs-info` / `ready-for-agent` / `ready-for-human` / `wontfix`). See `docs/agents/triage-labels.md`.
